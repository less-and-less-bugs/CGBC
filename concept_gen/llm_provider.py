...
class LLMProvider:
    ...
    async def _generate_openai(self,
        ...
        try:
            ...
            # print(self.model)
            # Combine all responses with newline if n>1
            response_texts = [choice.message.content for choice in completion.choices]
            response_text = '\n'.join(response_texts)
            ...
            return GenerationResult(
                ...
                finish_reason=completion.choices[0].finish_reason  # Use first choice's finish reason
            )
...
__all__ = ['LLMProvider', 'ProviderType', 'GenerationConfig', 'GenerationResult']
